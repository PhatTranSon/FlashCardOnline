...
class CollectionModal extends React.Component {
    ...
    onFormSubmit(event) {
        ...
        //Call props method
        this.props.onUpdateCollection({ title, description, color });
    }
                ...
                <div className="create-collection-modal">
                    {
                        ...
                        <div className="modal-success">
                            <h1 className="modal-success-title">Successfully updated collection</h1>
                            <a
                        ...
                        <>
                            <h1 className="collection-modal-title">Update flashcard collection</h1>
                            {
                                error ? 
                            ...
                            <form onSubmit={this.onFormSubmit}>
                                <div className="field">
                                    ...
                                    <div className="control">
                                        <input name="title" className="input round-input" type="text" placeholder="Choose title" defaultValue={title}/>
                                    </div>
                                </div>
                                ...
                                <div className="field">
                                    ...
                                    <div className="control">
                                        <textarea name="description" className="textarea round-input" type="text" placeholder="Choose description" defaultValue={description}/>
                                    </div>
                                </div>
